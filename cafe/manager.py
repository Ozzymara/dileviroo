...
class UserManager(BaseUserManager):
    ...
    Attributes:
        use_in_migrations (bool): Enables this manager to be used during migrations # noqa: E501
    ...
    def create_user(self, phone, password=None, **extra_fields):
        ...
        unique identifier. Sets the password and saves the user to the database. # noqa: E501
    ...
    def create_superuser(self, phone, password, **extra_fields):
        ...
        Note:
            ...
            These permissions are required for admin access and management functions # noqa: E501
        """
