...
urlpatterns = [
    ...
    path('reviews/edit/<int:review_id>/', views.edit_review, name='edit_review'),  # noqa: E501
    path('reviews/delete/<int:review_id>/', views.delete_review, name='delete_review'),  # noqa: E501
