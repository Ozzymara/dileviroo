...
urlpatterns = [
    ...
    path('delete_dish/<int:item_id>/', views.delete_dish, name='delete_dish'),  # Delete menu item
    path('manage_menu', views.manage_menu, name='manage_menu'),  # Add new menu items
    ...
    # User account URLs
    path('profile', views.profile, name='profile'),  # User profile (auth required)
    ...
    # path('checkout', views.checkout, name='checkout'),  # Future payment integration
    path('my_orders', views.my_orders, name='my_orders'),  # User order history
    path('all_orders', views.all_orders, name='all_orders'),  # All orders (staff only)
    
    # Billing URLs (staff/admin only)
    path('generate_bill', views.generate_bill, name='generate_bill'),  # Generate table bills
