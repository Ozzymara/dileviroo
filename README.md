...
*   **Celebrate Mentorship**: Embed playful and meaningful gestures for the educators who shaped my journey.
...
*   **Operational Efficiency:** Streamline admin tasks like order management, bill generation, and review moderation through a customised dashboard.
...
Click here to view the project [Kanban board](https://github.com/users/Ozzymara/projects/14)
...
| Section | Background Colour Name | Background Hex | Background RGB   | Foreground Colour Name | Foreground Hex | Foreground RGB  | Ratio  | AAA Result |
|---------|-----------------------|----------------|-----------------|-----------------------|----------------|-----------------|--------|------------|
...
<img src="/colour.jpg" alt="colour palette" style="width:100%;"></details><br>
...
By emphasising visual harmony and strict adherence to WCAG AAA contrast requirements, Dileviroo creates an interactive customer experience environment that is both engaging and accessible.
...
| cart.html            | Shopping cart with current orders | <details><summary>view wireframe</summary><img src="/wireframes/w-cart.png" alt="wireframe" style="width:100%;"></details> |
| my_orders.html       | User order history and details  | <details><summary>view wireframe</summary><img src="/wireframes/w-myorder.png" alt="wireframe" style="width:100%;"></details> |
| reviews.html         | Customer reviews and comments   | <details><summary>view wireframe</summary><img src="/wireframes/w-reviews.png" alt="wireframe" style="width:100%;"></details> |

---

# ✨ Features

This website is designed for clarity and ease of use and is structured to encourage interaction.

## 🏷️ Title and Favicon

<details>
<summary>Click to view browser title</summary>
<img src="C:\Users\user\Desktop\readme\tab.webp" alt="Browser title" style="width:50%;"></details><br>
...
• The favicon (the small icon next to the site title in the browser tab) is the Dileviroo logo icon. The icon helps users quickly identify the site when they have multiple tabs open.<br>
...
<img src="/navbar.webp" alt="Navbar" style="width:100%;"></details><br>
</details>
...
<img src="/admin_navbar.webp" alt="Navbar" style="width:100%;"></details><br>
...
<img src="/navbar_mobile.webp" alt="Navbar" style="width:50%;"></details><br>
...
<img src="C:\Users\user\Desktop\readme\menusearch.gif" alt="Navbar" style="width:100%;"></details><br>
...
<img src="/footer.webp" alt=" audio toggle feature" style="width:50%;"></details><be>
...
<img src="C:\Users\user\Desktop\readme\Validation\responsiveness.webp" alt="Responsiveness" style="width:100%;"></details>
...
<img src="/ERD.webp" alt=" audio toggle feature" style="width:100%;"></details><br>
...
### 1️⃣ Strategy Plane  -  ***Why are we building this?***
...
- **Tribute Element**
    - Honour mentors through a playful, meaningful brand identity (“Dileviroo”).

### 2️⃣ Scope Plane  -  ***What are we building?***
...
- **Content Requirements**
    ...
    - Messaging for empty states, confirmations, and errors

### 3️⃣ Structure Plane  -  ***How is it organised?***
...
- **Information Architecture**
    ...
    - Consistent layout via `base.html` for shared UI elements

### 4️⃣ Skeleton Plane  -  ***How does it behave?***
...
### 5️⃣ Surface Plane  -  ***What does it look like?***
...
- **Sensory Design**
    ...
    - Accessible colour contrasts and semantic HTML for inclusive design
...
- Access control for logged-in users (edit/delete icons, restricted content, etc.)
...
- Automated and manual testing/validation ensure security-critical features work as intended
...
This protects users from CSRF attacks that could otherwise allow unauthorised commands to run in their session.
...
|-----------------------------------------------------------------------|--------------------------------------------------------|--------------------------------------------|-------------|
| "Password cannot exceed 8 characters!"                               | User types more than 8 characters in password field     | Enforce password length limit               | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| "Item added to cart!"                                                 | User clicks "Add to Cart" button                         | Confirm successful cart addition            | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| "Please select a table before placing your order!"                   | User tries to place order without selecting table        | Prevent incomplete orders                    | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| "Your order has been placed successfully!"                           | Order is successfully submitted                          | Confirm order placement                      | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| "Please fill in all required fields!"                                | User submits form with missing data                      | Form validation reminder                     | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| "Are you absolutely sure you want to delete this review? This action cannot be undone." | User clicks the delete (submit) button on a review form | Prevent accidental review deletions          | <details><summary>view notification</summary><img src="/notifications/delete-confirmation.png" alt="Delete Confirmation" style="width:100%;"></details> |
| "Are you sure you want to log out?"                                  | User clicks a logout link                                | Confirm user intent to log out               | <details><summary>view notification</summary><img src="/notifications/logout-confirmation.png" alt="Logout Confirmation" style="width:100%;"></details> |
...
|-------------------------|---------------------------------|----------------------------|-------------|
| Login Success           | Successful user authentication   | Welcome user after login    | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| Login Error             | Failed authentication attempt    | Inform user of login failure| <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| Order Confirmation      | Order successfully placed        | Confirm order submission    | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
| Form Validation Errors  | Invalid form submission          | Display validation errors   | <details><summary>view notification</summary><img src="/notifications/Sign up.png" alt="notification" style="width:100%;"></details> |
...
- Static and media files are served securely (using tools such as WhiteNoise).

These combined measures help ensure user data is handled with care and protected from common threats, meeting the requirements for a modern, interactive Django web application.
...
| │   ├─ `forms.py`                          | Defines Django form classrs                    |
...
<img src="C:\Users\user\Desktop\readme\Validation\htmlval.webp" alt="HTML validation results" style="width:50%;">
...
<img src="C:\Users\user\Desktop\readme\Validation\cssval.webp" alt="CSS validation results" style="width:80%;">
</details><br>
...
To ensure code clarity, consistency, and maintainability across all modern environments, I ran the project through JS Hint.

<details>
<summary>Click to view JS Hint validation results</summary>
<img src="C:\Users\user\Desktop\readme\Validation\jshint.webp" alt="JS validation results" style="width:10
%;"></details><br>
...
<img src="C:\Users\user\Desktop\readme\Validation\wave.webp" alt="Wave results" style="width:100%;"></details><br>
...
<img src="C:\Users\user\Desktop\readme\Validation\lighthouse.webp" alt="Lighthouse results for mobile" style="width:100%;"></details><br>

Mobile
<details>
<summary>Click to view Lighthouse results for mobile</summary>
<img src="C:\Users\user\Desktop\readme\Validation\mobile.webp" alt="Lighthouse results for mobile" style="width:100%;"></details><br>
<br>

## [✅ SQL Queries]

Using `django-debug-toolbar 5.2.0`, various Django template pages were tested by generating SQL queries. The tests were run in production mode locally with `DEBUG=True`. 

<details>
<summary>Click to view test grid</summary>
<img src="C:\Users\user\Desktop\readme\Validation\sqlquries.webp" alt="Test grid" style="width:100%;"></details><br>
...
<img src="C:\Users\user\Desktop\readme\Validation\sqlgenbill.webp" alt="Test grid" style="width:100%;">
...
•	Page Load Times: Varying between approximately 0.2 ms to 105 ms.
•	Queries: Minimal, with 1 to 4 queries per page.

<details>
<summary>Click to view test grid</summary>
<img src="Validation\cipython.webp" alt="Test grid" style="width:100%;"></details><br>
...
<img src="C:\Users\user\Desktop\readme\Validation\controls.webp" alt="Test grid" style="width:100%;"></details><br>
...
* In VS Code, create a `.gitignore` file and add `.venv/` and `env.py` to it.
...
* Add Django to requirements: `pip3 freeze --local > requirements.txt`.

## 5. Create Django Project & App
* Start your project:
    * `django-admin startproject your_project_name .`
* Create a new app:
    * `python3 manage.py startapp app_name`
* In `settings.py`, add `'app_name'` to `INSTALLED_APPS`.
...
## 8. Prepare for Heroku Deployment
...
* On Heroku, deploy the connected branch and click “View” to see your live site.

## 10. Working With Repos
* Clone: On GitHub, copy the repo URL; in terminal: `git clone <repository-url>`.
* Fork: On GitHub, click “Fork” to make a copy to your account.
